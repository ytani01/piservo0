...
class CmdStrClient(CmdApiClient):
    ...
    def __init__(
            self, url, cmdline, history_file, angle_factor, debug=False
    ):
        super().__init__(url, cmdline, history_file, debug)
        ...
        self.parser = StrCmdToJson(self.angle_factor, debug=self._debug)
